...
def extract_school_info(input_csv):
    ...
    fieldnames = ['School-Name', 'School-Type', 'District', 'School-Level', 'Address', 'Latitude', 'Longitude']
...
def determine_school_level(low_grade, high_grade):
    ...
    if low_grade in ['PK', 'KG', '01', '02', '03', '04', '05'] or high_grade in ['PK', 'KG', '01', '02', '03', '04', '05']:
